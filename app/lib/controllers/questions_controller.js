QuestionsController = RouteController.extend({
  onBeforeAction: function() {
    var e = this.params.code || Session.get('currentEvent');
    if (e)
      Meteor.call('/cil/comment/list', e);
    this.next();
  },
  ...
  data: function () {
    return Questions.find({code: this.params.code});
  },
  ...
  action: function () {
    ...
    // last parameter.
    this.render('Questions', { data: {question: this.data()} });
  }
});
